...
describe('Integration | Domain | Services | user-service', () => {
  ...
  describe('#createUserWithPassword', () => {
    ...
    it('should return saved user and authenticationMethod', async () => {
      ...
      // when
      const { savedUser, savedAuthenticationMethod } = await userService.createUserWithPassword({
        user,
        hashedPassword,
        userRepository,
      ...
      // then
      expect(pick(savedUser, userPickedAttributes)).to.deep.equal(expectedUser);
      expect(pick(savedAuthenticationMethod, authenticationMethodPickedAttributes))
        .to.deep.equal(expectedAuthenticationMethod);
      expect(savedUser.id).to.equal(savedAuthenticationMethod.userId);
    });
